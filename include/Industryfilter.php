...
FROM job
INNER JOIN job_sub_category ON job.subcategory_id = job_sub_category.subcategory_id
WHERE job_sub_category.category_id =  '$category_id' 
...
INNER JOIN job_sub_category ON job.subcategory_id = job_sub_category.subcategory_id
WHERE job_sub_category.category_id =  '$category_id'  AND DATE(end_ad_date) >= DATE(now()) ".$limit;
