...
--
-- Create schema `get-the-job`
--

CREATE DATABASE IF NOT EXISTS `get-the-job`;
USE `get-the-job`;
...
INSERT INTO `district` (`DistrictID`,`DistrictName`,`RegionID`) VALUES 
 (1,'Far North',9),
 (2,'Franklin',1),
 (3,'Thames-Coromandel',13),
 (4,'Hauraki',13),
 (5,'Waikato',13),
 (6,'Matamata-Piako',13),
 (7,'Hamilton',13),
 ...
 (23,'Hastings',5),
 (24,'Napier',5),
 (25,'Central Hawkes Bay',5),
 (26,'New Plymouth',12),
 (27,'Stratford',12),
 (28,'South Taranaki',12),
 (29,'Ruapehu',6),
 (30,'Wanganui',6),
 (31,'Rangitikei',6),
 (32,'Manawatu',6),
 (33,'Rodney',1),
 (34,'Palmerston North',6),
 (35,'Tararua',6),
 (36,'Horowhenua',6),
 (37,'Kapiti Coast',14),
 (38,'Porirua',14),
 ...
 (42,'Masterton',14),
 (43,'Carterton',14),
 (44,'North Shore City',1),
 (45,'South Wairarapa',14),
 (46,'Tasman',8),
 (47,'Nelson',8),
 (48,'Marlborough',7),
 (49,'Kaikoura',7),
 ...
 (54,'Waimakariri',3),
 (55,'Waitakere City',1),
 (56,'Christchurch City',3),
 (57,'Banks Peninsula',3),
 (58,'Selwyn',3),
 (59,'Ashburton',3),
 (60,'Timaru',3),
 (61,'Mackenzie',3),
 ...
 (74,'South Otago',10),
 (75,'Manukau City',1),
 (76,'Hauraki Gulf Islands',1),
 (77,'Papakura',1);
/*!40000 ALTER TABLE `district` ENABLE KEYS */;


--
-- Definition of table `employer_agent/company`
--

DROP TABLE IF EXISTS `employer_agent/company`;
CREATE TABLE `employer_agent/company` (
  `EMPLOYER_ID` int(11) NOT NULL AUTO_INCREMENT,
  `FirstName` varchar(45) DEFAULT NULL,
  `LastName` varchar(45) DEFAULT NULL,
  `Address` varchar(50) DEFAULT NULL,
  `Company/AgentLogo` blob,
  `MobilePhone` int(11) DEFAULT NULL,
  `WorkPhone` int(11) DEFAULT NULL,
  `EmailForApplication` varchar(50) DEFAULT NULL,
  `Company/AgentURL` varchar(100) DEFAULT NULL,
  `EMPLOYER_TYPE_ID` int(11) DEFAULT NULL,
  `AGENT/COMPANY_NAME` varchar(50) DEFAULT NULL,
  `Username/Email` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`EMPLOYER_ID`),
  UNIQUE KEY `Username/Email_UNIQUE` (`Username/Email`),
  KEY `EmployerTypeID_idx` (`EMPLOYER_TYPE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `employer_agent/company`
--

/*!40000 ALTER TABLE `employer_agent/company` DISABLE KEYS */;
/*!40000 ALTER TABLE `employer_agent/company` ENABLE KEYS */;


--
-- Definition of table `employer_type`
--
...
CREATE TABLE `job_alert` (
  ...
  `Area/DistrictIDs` varchar(45) DEFAULT NULL,
...
INSERT INTO `job_category` (`CategoryID`,`CategoryName`) VALUES 
 (1,'Accounting'),
...
--
-- Definition of table `job_jobseeker`
--
...
--
-- Definition of table `job_seeker`
--
...
--
-- Definition of table `job_sub_category`
--
...
INSERT INTO `job_sub_category` (`SubCategoryID`,`SubCategoryName`,`CategoryID`) VALUES 
 (1,'Accountants',1),
 (2,'Accounts payable',1),
 (3,'Accounts receivable',1),
 (4,'Accounts administrators',1),
 (5,'Finance managers & controllers',1),
 (6,'Management',1),
 (7,'Payroll',1),
 (8,'Other',1),
 (9,'Farming',2),
 ...
 (13,'Other',2),
 (14,'Analysts',3),
 (15,'Tellers & branch staff',3),
 (16,'Client services',3),
 (17,'Corporate & institutional banking',3),
 (18,'Credit & lending',3),
 (19,'Financial planning & investment',3),
 (20,'Insurance',3),
 (21,'Management',3),
 (22,'Other',3),
 (23,'Architecture',4),
 (24,'Drafting',4),
 (25,'Estimation',4),
 (26,'Interior design',4),
 (27,'Planning',4),
 (28,'Labouring',4),
 (29,'Project & contracts management',4),
 (30,'Site management',4),
 (31,'Supervisors & forepersons',4),
 (32,'Surveying',4),
 (33,'Other',4),
 (34,'Customer-facing',5),
 (35,'Management',5),
 (36,'Other',5),
 (37,'Early childhood',6),
 (38,'Primary',6),
 (39,'Secondary',6),
 (40,'Tertiary',6),
 (41,'Other',6),
 (42,'Building services',7),
 (43,'Civil & structural',7),
 (44,'Drafting',7),
 (45,'Electrical',7),
 (46,'Environmental',7),
 (47,'Maintenance',7),
 (48,'Management',7),
 (49,'Mechanical',7),
 (50,'Project management',7),
 (51,'Water & waste',7),
 (52,'Other',7),
 (53,'Drivers & couriers',21),
 (54,'Freight forwarders',21),
 (55,'Operations',21),
 (56,'Management',21),
 (57,'Supply chain & planning',21),
 (58,'Warehouse & distribution',21),
 (59,'Import & export',21),
 (60,'Other',21),
 (61,'Local & regional council',8),
 (62,'Central government',8),
 (63,'Defence',8),
 (64,'Other',8),
 (65,'Administration',9),
 (66,'Caregiving',9),
 (67,'Community & social services',9),
 (68,'Dentistry',9),
 (69,'Doctors & specialists',9),
 (70,'Management',9),
 (71,'Nursing & midwifery',9),
 (72,'Occupational therapy',9),
 (73,'Pharmacy',9),
 (74,'Physiotherapy',9),
 (75,'Psychology & counselling',9),
 (76,'Radiography & sonography',9),
 (77,'Other',9),
 (78,'Bar staff & baristas',10),
 (79,'Waiting staff',10),
 (80,'Chefs',10),
 (81,'Reception & front desk',10),
 (82,'Kitchen staff',10),
 (83,'Management',10),
 (84,'Travel consultants',10),
 (85,'Other',10),
 (86,'HR',11),
 (87,'Recruitment',11),
 (88,'Other',11),
 (89,'Architects',12),
 (90,'Business & systems analysts',12),
 (91,'Database',12),
 (92,'Service desk',12),
 (93,'Management',12),
 (94,'Networking & storage',12),
 (95,'Programming & development',12),
 (96,'Project management',12),
 (97,'Sales & pre-sales',12),
 (98,'Telecommunications',12),
 (99,'Testing',12),
 (100,'Web design',12),
 (101,'Other',12),
 (102,'Secretarial',13),
 (103,'In-house counsel',13),
 (104,'Private practice',13),
 (105,'Other',13),
 (106,'Fitters & machining',14),
 (107,'Machine operation',14),
 (108,'Management',14),
 (109,'Process & assembly',14),
 (110,'Purchasing & inventory',14),
 (111,'Quality assurance',14),
 (112,'Storepersons & warehousing',14),
 (113,'Other',14),
 (114,'Brand & product management',15),
 (115,'Design',15),
 (116,'Direct marketing',15),
 (117,'Market research & analysis',15),
 (118,'Marketing assistants & coordinators',15),
 (119,'Communications & PR',15),
 (120,'Management',15),
 (121,'Journalism',15),
 (122,'Other',15),
 (123,'Administration',16),
 (124,'Data entry',16),
 (125,'Office management',16),
 (126,'EA, PA & secretarial',16),
 (127,'Reception',16),
 (128,'Other',16),
 (129,'Account management',19),
 (130,'Business development manager',19),
 (131,'Sales Managers',19),
 (132,'Sales Reps',19),
 (133,'Sales Support',19),
 (134,'Telesales',19),
 (135,'Other',19),
 (136,'Merchandising',18),
 (137,'Management',18),
 (138,'Retail assistants',18),
 (139,'Store managers',18),
 (140,'Assistant store managers',18),
 (141,'Other',18),
 (142,'Automotive trades',20),
 (143,'Air con. & refrigeration',20),
 (144,'Boilermakers & welders',20),
 (145,'Butchers & bakers',20),
 (146,'Building & carpentry',20),
 (147,'Cleaning',20),
 (148,'Electrical',20),
 (149,'Gardening & landscaping',20),
 (150,'Hairdressing',20),
 (151,'Handy-persons',20),
 (152,'Labourers',20),
 (153,'Painting',20),
 (154,'Plumbing',20),
 (155,'Printing',20),
 ...
 (157,'Technicians',20),
 (158,'Other',20),
 (159,'Risk & compliance',3),
 (160,'Analysts',1),
 (161,'Settlements',3),
 (162,'Machine operators',4),
 (163,'Tutoring & training',6),
 (164,'Energy',7),
 (165,'Industrial',7),
 (166,'Housekeeping',10),
 (167,'Functional consultants',12),
 (168,'Security',12),
 (169,'Training',12),
 (170,'Supervisors & forepersons',14),
 (171,'Beautician',20),
 (172,'Boat building',20),
 (173,'Flooring',20),
 (174,'Glaziers',20),
 (175,'Roofing',20),
 (176,'Sign writers',20),
 (177,'Quantity surveying',4),
 (178,'Call centre',5),
 (179,'Au pairs & nannies',6),
 (180,'Geotechnical',7),
 (181,'Fitness & wellbeing',9),
 (182,'Veterinary',9),
 (183,'Tourism & tour guides',10),
 (184,'Data warehousing & BI',12),
 (185,'Systems engineers',12),
 (186,'Advertising',15),
 (187,'Digital marketing',15),
 (188,'Area managers',18),
 (189,'Buying',18),
 (190,'Department managers',18),
 (191,'Commercial sales & leasing',17),
 (192,'Consultancy & valuation',17),
 (193,'Facilities & commercial property management',17),
 (194,'Residential sales & management',17),
 (195,'Other',17);
/*!40000 ALTER TABLE `job_sub_category` ENABLE KEYS */;


--
-- Definition of table `jobalert_district`
--
...
--
-- Definition of table `jobseeker_resume`
--
...
--
-- Definition of table `salary_range`
--
