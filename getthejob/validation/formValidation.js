  ...
  <![CDATA[ 
            jQuery(function(){
				jQuery("#mobPhone").validate({
                    expression: "if (VAL.match(/^[0][0-9]{8}$/)) return true; else return false;",  
                    message: "Should be a valid Mobile Number"
                }); 
			jQuery("#uname").validate({
                    expression: "if (VAL && VAL.lenght > 3) return true; else return false;",
                    message: "<font color='#dd0000'>Please enter a valid username, should be at least of 4 characters.</font>"
				});
			...
			jQuery("#fname").validate({
                    ...
                    message: "<font color='#dd0000'>Please enter your first name.</font>"
				});
			});
  ]]> 		
 */